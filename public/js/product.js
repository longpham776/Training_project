...
$('.btnStore').on('click', function (e) {
  ...
  var addData = new FormData($('#addProduct')[0]);
...
$('#btnDelete').on('click', function (e) {
  ...
  var result = confirm("Bạn có muốn xóa sản phẩm " + product_name + " không");
  if (!result) {
    return false;
  }
  $.ajax({
    ...
    success: function success(mess) {
      ...
      $("#product".concat(product_id)).remove();
...
/******/ 	var __webpack_exports__ = __webpack_require__("./resources/js/product.js");
/******/ 	
/******/ })()
;